    ...
    public static class CyclicTests
    {
        ...
        public static void WriteCyclicFail(int depth)
        {
...

            {
                ...
                // Since the last Parent property is null, the serializer will move onto the Children property.
                string expectedPath = "$" + string.Concat(Enumerable.Repeat(".Parent", depth - 1)) + ".Children";
